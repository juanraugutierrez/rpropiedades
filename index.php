        ...
        <div class="sl-slider">
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">Ventas, Compras y Arriendos</a></h2>
              <blockquote>              
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">Asesoria Inmobilaria</a></h2>
              <blockquote>              
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> 1890 Syndey, Australia</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite>$ 20,000,000</cite>
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">Tramites ante el conservador de bienes raices</a></h2>
              <blockquote>              
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> 1890 Syndey, Australia</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite>$ 20,000,000</cite>
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-5" data-slice2-rotation="10" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">Estudio de Titulos</a></h2>
              <blockquote>              
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> 1890 Syndey, Australia</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite>$ 20,000,000</cite>
...
<div class="banner-search">
  <div class="container"> 
    <!-- banner -->
    <h3>Compra, Venta y Arriendo</h3>
    <div class="searchbar">
      <div class="row">
        <div class="col-lg-6 col-sm-6">
          <input type="text" class="form-control" placeholder="Busqueda de propiedades">
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-4">
              <select class="form-control">
                ...
                <option>700 UF - 1200 UF</option>
                <option>1201 UF - 1500 UF </option>
                <option>1501 UF - 3000 UF</option>
                <option>3001 UF - Más</option>
              </select>
            </div>
            <div class="col-lg-3 col-sm-4">
            <select class="form-control">
...
<!-- banner -->
<div class="container">
  <div class="properties-listing spacer"> <a href="buysalerent.php" class="pull-right viewall">Ver la lista completa</a>
    <h2>Propiedades Destacadas</h2>
    <div id="owl-example" class="owl-carousel">
      <div class="properties">
        <div class="image-holder"><img src="images/properties/1.jpg" class="img-responsive" alt="properties"/>
          <div class="status sold">Vendida</div>
        </div>
        <h4><a href="property-detail.php">Propiedades</a></h4>
          ...
          <div class="carousel-inner">
            <div class="item active">
              <div class="row">
                ...
                <div class="col-lg-8">
                  <h5><a href="property-detail.php">Oferta</a></h5>
